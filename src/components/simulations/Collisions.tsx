  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm text-gray-600 dark:text-gray-400 font-mono">
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg px-3 py-2"><SimMath math="m_1v_1 + m_2v_2 = m_1v_1' + m_2v_2'" /></div>
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg px-3 py-2"><SimMath math="e = -\frac{v_2' - v_1'}{v_2 - v_1}" /></div>
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg px-3 py-2"><SimMath math="KE = \frac{1}{2}mv^2" /></div>
        </div>
      </div>

      <p className="text-xs text-gray-500 dark:text-gray-500 text-center">
        Adjust masses and velocities, then watch the collision. Compare momentum before and after!
      </p>
    </div>
  );
}
