    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm text-gray-600 dark:text-gray-400 font-mono">
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg px-3 py-2">E = hf</div>
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg px-3 py-2">KE_max = hf − φ</div>
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg px-3 py-2">f₀ = φ / h</div>
        </div>
        <div className="mt-2 text-xs text-gray-500 dark:text-gray-500 font-mono">
          h = 4.136 × 10⁻¹⁵ eV·s (Planck&apos;s constant)
        </div>
      </div>
    </div>
  );
